...
*
*	Inputs:  "C:/Users/pkaberia/Dropbox//FP-Project-APHRC-UM/Atelier_FP/Codes//QUESTIONNAIRE EPS_WIDE.csv"
*	Outputs: "C:/Users/pkaberia/Dropbox//FP-Project-APHRC-UM/Atelier_FP/Data/Donnees brutes//QUESTIONNAIRE EPS.dta"
*
*	Output by SurveyCTO February 14, 2025 10:43 AM.
...
local csvfile "C:/Users/pkaberia/Dropbox//FP-Project-APHRC-UM/Atelier_FP/Codes//QUESTIONNAIRE EPS_WIDE.csv"
local dtafile "C:/Users/pkaberia/Dropbox//FP-Project-APHRC-UM/Atelier_FP/Data/Donnees brutes//QUESTIONNAIRE EPS.dta"
local corrfile "C:/Users/pkaberia/Dropbox//FP-Project-APHRC-UM/Atelier_FP/Codes//QUESTIONNAIRE EPS_corrections.csv"
local note_fields1 ""
local text_fields1 "s1_4 s1_8 s1_10 s4_1_2_1 personnel_1_count numerob_produitf_1_* codeb_produitf_1_* produitb_labelg_1_* s4_1_8_1_* s4_1_11_1_* s4_1_12_1_* s4_1_12au_1_* s4_1_2_2 personnel_2_count numerob_produitf_2_*"
local text_fields2 "codeb_produitf_2_* produitb_labelg_2_* s4_1_11_2_* s4_1_12_2_* s4_1_12au_2_* servi_smni s_cpn s5_5_cpn s5_5_cpn_autre s_acc s5_5_acc s5_5_acc_autre s_pnat s5_5_pnat s5_5_pnat_autre s_nne s5_5_nne"
local text_fields3 "s5_5_nne_autre s_avo s5_5_avo s5_5_avo_autre s_inf s5_5_sinf s5_5_sinf_autre s5_10 s5_10_autre s5_10a s5_10_autrea s5_10b s5_10_autreb s5_10c s5_10_autrec s5_10e s5_10_autree s5_10f s5_10_autref"
local text_fields4 "s5_10g s5_10_autreg s5_10h s5_10_autreh s5_10j s5_10_autrej s5_10k s5_10_autrek s5_10l s5_10_autrel s6_2 s6_2_1 s6_19 s6_20 s6_19a s6_20a s6_19b s6_20b s6_19c s6_20c s6_19d s6_20d s6_19e s6_20e s6_19f"
local text_fields5 "s6_20f s6_19g s6_20g s6_19h s6_20h s6_19i s6_20i s6_19j s6_20j obs instanceid"
...
if _N>0 {
	...
	* label variables
	...
	label variable s3_1_1_1 "301A. L'EPS dispose t-il d'une salle d'attente avec des sièges ?"
	note s3_1_1_1: "301A. L'EPS dispose t-il d'une salle d'attente avec des sièges ?"
	label define s3_1_1_1 1 "Oui" 2 "Non"
	label values s3_1_1_1 s3_1_1_1

	label variable s3_1_2_1 "301B. L'EPS dispose t-il de toilettes pour hommes avec eau courante dans la sall"
	note s3_1_2_1: "301B. L'EPS dispose t-il de toilettes pour hommes avec eau courante dans la salle d'attente ?"
	label define s3_1_2_1 1 "Oui" 2 "Non"
	label values s3_1_2_1 s3_1_2_1

	label variable s3_1_3_1 "301C. L'EPS dispose t-il de toilettes pour femmes avec eau courante dans la sall"
	note s3_1_3_1: "301C. L'EPS dispose t-il de toilettes pour femmes avec eau courante dans la salle d'attente ?"
	label define s3_1_3_1 1 "Oui" 2 "Non"
	label values s3_1_3_1 s3_1_3_1

	label variable s3_1_4_1 "301D. L'EPS dispose t-il de dispositif de lavage des mains ?"
	note s3_1_4_1: "301D. L'EPS dispose t-il de dispositif de lavage des mains ?"
	label define s3_1_4_1 1 "Oui" 2 "Non"
	label values s3_1_4_1 s3_1_4_1

	label variable s3_1_5_1 "301E. L'EPS dispose t-il d'eau potable ?"
	note s3_1_5_1: "301E. L'EPS dispose t-il d'eau potable ?"
	label define s3_1_5_1 1 "Oui" 2 "Non"
	label values s3_1_5_1 s3_1_5_1

	label variable s3_1_6_1 "301F. L'EPS dispose t-il d'alimentation en électricité ?"
	note s3_1_6_1: "301F. L'EPS dispose t-il d'alimentation en électricité ?"
	label define s3_1_6_1 1 "Oui" 2 "Non"
	label values s3_1_6_1 s3_1_6_1

	label variable s3_1_8_1 "301G. L'EPS dispose t-il de laboratoire ?"
	note s3_1_8_1: "301G. L'EPS dispose t-il de laboratoire ?"
	label define s3_1_8_1 1 "Oui" 2 "Non"
	label values s3_1_8_1 s3_1_8_1

	label variable s3_1_8_1a "301H. L'EPS dispose t-il de service d'imagerie ?"
	note s3_1_8_1a: "301H. L'EPS dispose t-il de service d'imagerie ?"
	label define s3_1_8_1a 1 "Oui" 2 "Non"
	label values s3_1_8_1a s3_1_8_1a

	label variable s3_1_9_1 "301I. L'EPS dispose t-il de salle d'opération (salle opératoire) ?"
	note s3_1_9_1: "301I. L'EPS dispose t-il de salle d'opération (salle opératoire) ?"
	label define s3_1_9_1 1 "Oui" 2 "Non"
	label values s3_1_9_1 s3_1_9_1

	label variable s3_1_10_1 "301J. L'EPS dispose t-il de pharmacies ?"
	note s3_1_10_1: "301J. L'EPS dispose t-il de pharmacies ?"
	label define s3_1_10_1 1 "Oui" 2 "Non"
	label values s3_1_10_1 s3_1_10_1

	label variable s3_1_11_1 "301K. L'EPS dispose t-il de panneaux de signalisation pour orientation ?"
	...
	label variable s3_1_12_1 "301L. L'EPS dispose t-il des rampes pour personnes handicapées ?"
	...
	label variable s3_1_13_1 "301M. L'EPS dispose t-il de salle de collecte des déchets biomédicaux ?"
	...
	label variable s3_1_14_1 "301N. L'EPS dispose t-il de parking automobile ?"
	...
	capture {
		foreach rgvar of varlist s4_1_3_0_* {
			label variable `rgvar' "Combien de \${produitb_labelg_1} sont autorisés dans le service de gynécologie?"
			note `rgvar': "Combien de \${produitb_labelg_1} sont autorisés dans le service de gynécologie?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_3_1_* {
			label variable `rgvar' "Combien de postes de \${produitb_labelg_1} sont actuellement vacants ?"
			note `rgvar': "Combien de postes de \${produitb_labelg_1} sont actuellement vacants ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_4a_1_* {
			label variable `rgvar' "Combien de \${produitb_labelg_1} sont de sexe masculin ?"
			note `rgvar': "Combien de \${produitb_labelg_1} sont de sexe masculin ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_4b_1_* {
			label variable `rgvar' "Combien de \${produitb_labelg_1} sont de sexe féminin ?"
			note `rgvar': "Combien de \${produitb_labelg_1} sont de sexe féminin ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_6a_1_* {
			label variable `rgvar' "Combien de \${produitb_labelg_1} femmes ont reçu une formation complémentaire su"
			note `rgvar': "Combien de \${produitb_labelg_1} femmes ont reçu une formation complémentaire sur le PF ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_6b_1_* {
			label variable `rgvar' "Combien de \${produitb_labelg_1} hommes ont reçu une formation complémentaire su"
			note `rgvar': "Combien de \${produitb_labelg_1} hommes ont reçu une formation complémentaire sur le PF ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_7a_1_* {
			label variable `rgvar' "Combien de \${produitb_labelg_1} femmes fournissent actuellement des services de"
			note `rgvar': "Combien de \${produitb_labelg_1} femmes fournissent actuellement des services de PF ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_7b_1_* {
			label variable `rgvar' "Combien de \${produitb_labelg_1} hommes fournissent actuellement des services de"
			note `rgvar': "Combien de \${produitb_labelg_1} hommes fournissent actuellement des services de PF ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_8_1_* {
			label variable `rgvar' "Quelles sont les méthodes que propose les \${produitb_labelg_1} dans la structur"
			note `rgvar': "Quelles sont les méthodes que propose les \${produitb_labelg_1} dans la structure ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_9a_1_* {
			label variable `rgvar' "Combien de \${produitb_labelg_1} femmes ont reçu une formation supplémentaire re"
			note `rgvar': "Combien de \${produitb_labelg_1} femmes ont reçu une formation supplémentaire reçue sur la SMNI ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_9b_1_* {
			label variable `rgvar' "Combien de \${produitb_labelg_1} hommes ont reçu une formation supplémentaire re"
			note `rgvar': "Combien de \${produitb_labelg_1} hommes ont reçu une formation supplémentaire reçue sur la SMNI ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_10a_1_* {
			label variable `rgvar' "Combien \${produitb_labelg_1} femmes fournissent actuellement des services de SM"
			note `rgvar': "Combien \${produitb_labelg_1} femmes fournissent actuellement des services de SMNI ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_10b_1_* {
			label variable `rgvar' "Combien \${produitb_labelg_1} hommes fournissent actuellement des services de SM"
			note `rgvar': "Combien \${produitb_labelg_1} hommes fournissent actuellement des services de SMNI ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_11_1_* {
			label variable `rgvar' "Quels sont les services de SMNI fournit par les services de SMNI \${produitb_lab"
			note `rgvar': "Quels sont les services de SMNI fournit par les services de SMNI \${produitb_labelg_1} ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_11_1a_* {
			label variable `rgvar' "Combien de \${produitb_labelg_1} femmes ont reçu une formation sur l'échographie"
			note `rgvar': "Combien de \${produitb_labelg_1} femmes ont reçu une formation sur l'échographie ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_11_1b_* {
			label variable `rgvar' "Combien de \${produitb_labelg_1} hommes ont reçu une formation sur l'échographie"
			note `rgvar': "Combien de \${produitb_labelg_1} hommes ont reçu une formation sur l'échographie ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_12_1_* {
			label variable `rgvar' "Pourquoi le poste de \${produitb_labelg_1} est-il actuellement vacant ?"
			note `rgvar': "Pourquoi le poste de \${produitb_labelg_1} est-il actuellement vacant ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_12au_1_* {
	...
	capture {
		foreach rgvar of varlist s4_1_13_1_* {
			label variable `rgvar' "En moyenne, depuis combien de temps le(les) poste(s) de \${produitb_labelg_1} es"
			note `rgvar': "En moyenne, depuis combien de temps le(les) poste(s) de \${produitb_labelg_1} est(sont)-il(s) vacant ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_3_0b_* {
			label variable `rgvar' "Combien de \${produitb_labelg_2} sont autorisés dans le service de pédiatrie?"
			note `rgvar': "Combien de \${produitb_labelg_2} sont autorisés dans le service de pédiatrie?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_3_2_* {
			label variable `rgvar' "Combien de postes de \${produitb_labelg_2} sont actuellement vacants ?"
			note `rgvar': "Combien de postes de \${produitb_labelg_2} sont actuellement vacants ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_4a_2_* {
			label variable `rgvar' "Combien de \${produitb_labelg_2} sont de sexe masculin ?"
			note `rgvar': "Combien de \${produitb_labelg_2} sont de sexe masculin ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_4b_2_* {
			label variable `rgvar' "Combien de \${produitb_labelg_2} sont de sexe féminin ?"
			note `rgvar': "Combien de \${produitb_labelg_2} sont de sexe féminin ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_9a_2_* {
			label variable `rgvar' "Combien de \${produitb_labelg_2} femmes ont reçu une formation supplémentaire re"
			note `rgvar': "Combien de \${produitb_labelg_2} femmes ont reçu une formation supplémentaire reçue sur la SMNI ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_9b_2_* {
			label variable `rgvar' "Combien de \${produitb_labelg_2} hommes ont reçu une formation supplémentaire re"
			note `rgvar': "Combien de \${produitb_labelg_2} hommes ont reçu une formation supplémentaire reçue sur la SMNI ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_10a_2_* {
			label variable `rgvar' "Combien \${produitb_labelg_2} femmes fournissent actuellement des services de SM"
			note `rgvar': "Combien \${produitb_labelg_2} femmes fournissent actuellement des services de SMNI ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_10b_2_* {
			label variable `rgvar' "Combien \${produitb_labelg_2} hommes fournissent actuellement des services de SM"
			note `rgvar': "Combien \${produitb_labelg_2} hommes fournissent actuellement des services de SMNI ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_11_2_* {
			label variable `rgvar' "Quels sont les services de SMNI fournit par les services de SMNI \${produitb_lab"
			note `rgvar': "Quels sont les services de SMNI fournit par les services de SMNI \${produitb_labelg_2} ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_12_2_* {
			label variable `rgvar' "Pourquoi le poste de \${produitb_labelg_2} est-il actuellement vacant ?"
			note `rgvar': "Pourquoi le poste de \${produitb_labelg_2} est-il actuellement vacant ?"
		}
	}

	capture {
		foreach rgvar of varlist s4_1_12au_2_* {
			label variable `rgvar' "Veuillez préciser le motif"
			note `rgvar': "Veuillez préciser le motif"
		}
	}
	...
	capture {
		foreach rgvar of varlist s4_1_13_2_* {
			label variable `rgvar' "Depuis combien de temps ce poste de \${produitb_labelg_2} est-il vacant ?"
			note `rgvar': "Depuis combien de temps ce poste de \${produitb_labelg_2} est-il vacant ?"
		}
	}
...
*
*   Corrections file path and filename:  C:/Users/pkaberia/Dropbox//FP-Project-APHRC-UM/Atelier_FP/Codes//QUESTIONNAIRE EPS_corrections.csv
*
