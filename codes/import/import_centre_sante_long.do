* import_centrsante_corr.do
*
* 	Imports and aggregates "QUESTIONNAIRE CENTRE DE SANTE" (ID: centrsante_corr) data.
*
*	Inputs:  "F:/Dropbox_APHRC/Dropbox/FP-Project-APHRC-UM/Atelier_FP/Data/raw/QUESTIONNAIRE CENTRE DE SANTE.csv"
*	Outputs: "F:/Dropbox_APHRC/Dropbox/FP-Project-APHRC-UM/Atelier_FP/Data/raw/QUESTIONNAIRE CENTRE DE SANTE.dta"
*
*	Output by SurveyCTO March 20, 2025 3:48 PM.
...
local csvfile "F:/Dropbox_APHRC/Dropbox/FP-Project-APHRC-UM/Atelier_FP/Data/raw/QUESTIONNAIRE CENTRE DE SANTE.csv"
local dtafile "F:/Dropbox_APHRC/Dropbox/FP-Project-APHRC-UM/Atelier_FP/Data/raw/centre_sante_main_long_raw.dta"
local corrfile "F:/Dropbox_APHRC/Dropbox/FP-Project-APHRC-UM/Atelier_FP/Data/raw/QUESTIONNAIRE CENTRE DE SANTE_corrections.csv"
local note_fields1 ""
local text_fields1 "autre_structure s1_4 s1_8 s1_10 s4_1_2 personnel_count servi_smni s_cpn s5_5_cpn s5_5_cpn_autre s_acc s5_5_acc s5_5_acc_autre s_pnat s5_5_pnat s5_5_pnat_autre s_nne s5_5_nne s5_5_nne_autre s_avo"
local text_fields2 "s5_5_avo s5_5_avo_autre s_inf s5_5_sinf s5_5_sinf_autre s5_10 s5_10_autre s5_10a s5_10_autrea s5_10b s5_10_autreb s5_10c s5_10_autrec s5_10e s5_10_autree s5_10f s5_10_autref s5_10g s5_10_autreg s5_10h"
...
if _N>0 {
	...
	* label variables
	...
	label variable s2_1 "201. Estimation de la population polarisée par le centre de santé"
	note s2_1: "201. Estimation de la population polarisée par le centre de santé"

	label variable s2_2 "202. Nombre de postes de santé relevant directement du centre de santé"
	note s2_2: "202. Nombre de postes de santé relevant directement du centre de santé"

	label variable s2_3 "203. Le centre de santé propose-t-il des services ambulatoires, des services hos"
	note s2_3: "203. Le centre de santé propose-t-il des services ambulatoires, des services hospitaliers ou les deux ?"
	label define s2_3 1 "Soins ambulatoires uniquement" 2 "Hospitalisation et soins ambulatoires"
	label values s2_3 s2_3

	label variable s3_1_1_1 "301A. Le centre de santé dispose t-il d'une salle d'attente avec des sièges ?"
	note s3_1_1_1: "301A. Le centre de santé dispose t-il d'une salle d'attente avec des sièges ?"
	label define s3_1_1_1 1 "Oui" 2 "Non"
	label values s3_1_1_1 s3_1_1_1

	label variable s3_1_2_1 "301B. Le centre de santé dispose t-il de toilettes pour hommes avec eau courante"
	note s3_1_2_1: "301B. Le centre de santé dispose t-il de toilettes pour hommes avec eau courante dans la salle d'attente ?"
	label define s3_1_2_1 1 "Oui" 2 "Non"
	label values s3_1_2_1 s3_1_2_1

	label variable s3_1_3_1 "301C. Le centre de santé dispose t-il de toilettes pour femmes avec eau courante"
	note s3_1_3_1: "301C. Le centre de santé dispose t-il de toilettes pour femmes avec eau courante dans la salle d'attente ?"
	label define s3_1_3_1 1 "Oui" 2 "Non"
	label values s3_1_3_1 s3_1_3_1

	label variable s3_1_4_1 "301D. Le centre de santé dispose t-il de dispositif de lavage des mains ?"
	note s3_1_4_1: "301D. Le centre de santé dispose t-il de dispositif de lavage des mains ?"
	label define s3_1_4_1 1 "Oui" 2 "Non"
	label values s3_1_4_1 s3_1_4_1

	label variable s3_1_5_1 "301E. Le centre de santé dispose t-il d'eau potable ?"
	note s3_1_5_1: "301E. Le centre de santé dispose t-il d'eau potable ?"
	label define s3_1_5_1 1 "Oui" 2 "Non"
	label values s3_1_5_1 s3_1_5_1

	label variable s3_1_6_1 "301F. Le centre de santé dispose t-il d'alimentation en électricité ?"
	note s3_1_6_1: "301F. Le centre de santé dispose t-il d'alimentation en électricité ?"
	label define s3_1_6_1 1 "Oui" 2 "Non"
	label values s3_1_6_1 s3_1_6_1

	label variable s3_1_8_1 "301G. Le centre de santé dispose t-il de laboratoire ?"
	note s3_1_8_1: "301G. Le centre de santé dispose t-il de laboratoire ?"
	label define s3_1_8_1 1 "Oui" 2 "Non"
	label values s3_1_8_1 s3_1_8_1

	label variable s3_1_8_1a "301H. Le centre de santé dispose t-il de service d'imagerie ?"
	note s3_1_8_1a: "301H. Le centre de santé dispose t-il de service d'imagerie ?"
	label define s3_1_8_1a 1 "Oui" 2 "Non"
	label values s3_1_8_1a s3_1_8_1a

	label variable s3_1_9_1 "301I. Le centre de santé dispose t-il de salle d'opération (salle opératoire) ?"
	note s3_1_9_1: "301I. Le centre de santé dispose t-il de salle d'opération (salle opératoire) ?"
	label define s3_1_9_1 1 "Oui" 2 "Non"
	label values s3_1_9_1 s3_1_9_1

	label variable s3_1_10_1 "301J. Le centre de santé dispose t-il de pharmacies ?"
	note s3_1_10_1: "301J. Le centre de santé dispose t-il de pharmacies ?"
	label define s3_1_10_1 1 "Oui" 2 "Non"
	label values s3_1_10_1 s3_1_10_1

	label variable s3_1_11_1 "301K. Le centre de santé dispose t-il de panneaux de signalisation pour orientat"
	note s3_1_11_1: "301K. Le centre de santé dispose t-il de panneaux de signalisation pour orientation ?"
	label define s3_1_11_1 1 "Oui" 2 "Non"
	label values s3_1_11_1 s3_1_11_1

	label variable s3_1_12_1 "301L. Le centre de santé dispose t-il des rampes pour personnes handicapées ?"
	note s3_1_12_1: "301L. Le centre de santé dispose t-il des rampes pour personnes handicapées ?"
	label define s3_1_12_1 1 "Oui" 2 "Non"
	label values s3_1_12_1 s3_1_12_1

	label variable s3_1_13_1 "301M. Le centre de santé dispose t-il de salle de collecte des déchets biomédica"
	note s3_1_13_1: "301M. Le centre de santé dispose t-il de salle de collecte des déchets biomédicaux ?"
	label define s3_1_13_1 1 "Oui" 2 "Non"
	label values s3_1_13_1 s3_1_13_1

	label variable s3_1_14_1 "301N. Le centre de santé dispose t-il de parking automobile ?"
	note s3_1_14_1: "301N. Le centre de santé dispose t-il de parking automobile ?"
	...
	label variable s3_15 "306. Le centre de santé dispose-t-il d'un laboratoire ?"
	note s3_15: "306. Le centre de santé dispose-t-il d'un laboratoire ?"
...
*
*   Corrections file path and filename:  F:/Dropbox_APHRC/Dropbox/FP-Project-APHRC-UM/Atelier_FP/Data/raw/QUESTIONNAIRE CENTRE DE SANTE_corrections.csv
*
...
do "F:\Dropbox_APHRC\Dropbox\FP-Project-APHRC-UM\Atelier_FP\codes\import_centre_sante_section_41-personnel.do"
