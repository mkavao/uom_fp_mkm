...
foreach var of var s5_2A s5_3A s5_3Aa s5_4A s5_4Aa s5_5A s5_5A1 s5_5A2 s5_5A3 s5_5A4 s5_5A5 s5_5A5other  {
	replace `var' = -9 if s5_1==2
}
...
foreach var of var  s5_3A s5_3Aa s5_4A s5_4Aa {
...
save "C:\Users\asandie\Desktop\structure_dm\Clean_data\eps_data_clean.dta",replace

rename key parent_key

merge m:m parent_key using "C:\Users\asandie\Desktop\structure_dm\Clean_data\eps_rh.dta"

*keep if _merge==3

drop _merge

save "C:\Users\asandie\Desktop\structure_dm\Clean_data\eps_data_clean_combined.dta",replace
