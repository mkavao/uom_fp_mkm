...
use "F:\Dropbox_APHRC\Dropbox\FP-Project-APHRC-UM\Atelier_FP\Data\raw\medecin_long_raw.dta"
...
drop equipe enqueteur s1_8 s1_9 methods_repeat_count setofmethods_repeat

lab def yesno 0 non 1 oui -5 missing -9 na,modify

****************************************************************
*Supprimer les variables inutiles
drop submissiondate start today deviceid obs end formdef_version
...
ren i5 s1_5
************************************** SECTION 2
replace s2_4_2=s2_4_1*12 if s2_4==1
replace s2_4_2 = -7 if s2_4==3

drop s2_4 s2_4_1
ren s2_4_2 s2_4  
lab var s2_4 "204. Depuis quand occupez-vous le poste actuel? mois"                   

replace s2_5_2=s2_5_1*12 if s2_5==1
replace s2_5_2 = -7 if s2_5==3

drop s2_5 s2_5_1
ren s2_5_2 s2_5  
lab var s2_5 "205. Depuis quand travaillez-vous dans cette formation sanitaire? mois"    

ren s2_6_1 s2_6autre


replace s2_8_2=s2_8_1*12 if s2_8==1
replace s2_8_2 = -7 if s2_8==3
replace s2_8_2 = -9 if s2_7==2

drop s2_8 s2_8_1
ren s2_8_2 s2_8  
lab var s2_8 "208. Depuis quand fournissez-vous des services de SMNI? mois"    

replace s2_9 = -9 if s2_7==2


replace s2_10_2=s2_10_1*12 if s2_10==1
replace s2_10_2 = -7 if s2_10==3
replace s2_10_2 = -9 if s2_7==2|s2_9==2

drop s2_10 s2_10_1
ren s2_10_2 s2_10  
lab var s2_10 "210. Depuis quand fournissez-vous des services de SMNI dans cette structure sani? mois" 
...
forval i = 1/4 {
    ...
    rename s2_12_`i' s2_12`newname'
    rename s2_13_`i' s2_13`newname'
    rename s2_14_`i' s2_14`newname'
	rename s2_14_`i'a s2_14`newname'utre
	drop s2_15_`i'
    rename s2_16_`i' s2_16`newname'
    rename s2_15_`i'_1 s2_15`newname'1
    rename s2_15_`i'_2 s2_15`newname'2
    rename s2_15_`i'_3 s2_15`newname'3
    rename s2_15_`i'_4 s2_15`newname'4
}


label var s2_15a1 "Formation en cours d'emploi"
label var s2_15a2 "Formation de remise à niveau"
label var s2_15a3 "Mentorat"
label var s2_15a4 "Aucune"

lab val s2_15?? yesno



foreach var of var s2_15?? s2_12? s2_13? s2_14? s2_16? {
replace `var' = -9 if s2_7==2|s2_9==2	
}


replace s2_13a = -9 if s2_12a==2	
replace s2_13b = -9 if s2_12b==2	
replace s2_13c = -9 if s2_12c==2	
replace s2_13d = -9 if s2_12d==2	

replace s2_14a = -9 if s2_12a==1	
replace s2_14b = -9 if s2_12b==1	
replace s2_14c = -9 if s2_12c==1	
replace s2_14d = -9 if s2_12d==1	

replace s2_14a = -9 if s2_13a==1
replace s2_14b = -9 if s2_13b==1	
replace s2_14c = -9 if s2_13c==1
replace s2_14d = -9 if s2_13d==1	

replace s2_16a=-9 if s2_15a4==1
replace s2_16b=-9 if s2_15b4==1
replace s2_16c=-9 if s2_15c4==1
replace s2_16d=-9 if s2_15d4==1

*****************************************************************************

replace s2_18_2=s2_18_1*12 if s2_18==1
replace s2_18_2 = -7 if s2_18==3

drop s2_18 s2_18_1
ren s2_18_2 s2_18  
lab var s2_18 "218. Depuis quand fournissez-vous des services de planification familiale? mois"  


replace s2_20_2=s2_20_1*12 if s2_20==1
replace s2_20_2 = -7 if s2_20==3

drop s2_20 s2_20_1
ren s2_20_2 s2_20  
lab var s2_20 "220. Depuis quand fournissez-vous des services de planification familiale dans? mois"  
...
forval i = 1/9 {
    local newname : word `i' of `alphabet'
    rename s3_2_`i' s3_2`newname'
}
 ren s3_2_96 s3_2x
 
lab val s3_2a-s3_2x yesno

label var s3_2a  "Age"
label var s3_2b  "Situation matrimoniale"
label var s3_2c  "Profession"
label var s3_2d  "Religion"
label var s3_2e  "Niveau d'éducation"
label var s3_2f  "Nombre d'enfants vivants"
label var s3_2g  "Age de l'enfant le plus jeune"
label var s3_2h  "Désir d'un enfant supplémentaire"
label var s3_2i  "Ne recueille aucune information"
label var s3_2x  "Autres (préciser)"
label var s3_2x_aut   "Préciser"

*******************************************************************

drop s3_3 s3_4

ren s3_3a s3_3x_autre
ren s3_4a s3_4x_autre
...
forval i = 1/7 {
    local newname : word `i' of `alphabet'
    rename s3_3_`i' s3_3`newname'
    rename s3_4_`i' s3_4`newname'
}
 ren s3_3_96 s3_3x
 ren s3_3_9 s3_3i
 
lab val s3_3a- s3_3i yesno


label var s3_3a "Date des dernières règles"
label var s3_3b "Durée du cycle menstruel"
label var s3_3c "Durée des règles"
label var s3_3d "Quantité de flux"
label var s3_3e "Règles douloureuses"
label var s3_3f "Régularité des règles"
label var s3_3g "Saignements entre les règles"
label var s3_3x "Autres (préciser)"
label var s3_3i "Ne recueille aucune information"
label var s3_3x_aut "Préciser"
